  ...
  Widget _moduleTile(int idx, Map<String, dynamic> m) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        IconButton(icon: Icon(Icons.edit_outlined, size: 16, color: AppColors.textSecondary), onPressed: () => _editModule(idx), padding: EdgeInsets.zero, constraints: const BoxConstraints()),
        const SizedBox(width: 8),
    ...
    return showDialog<Map<String, dynamic>>(context: context, builder: (ctx) =>
      StatefulBuilder(builder: (ctx, ss) => AlertDialog(
        ...
        content: SingleChildScrollView(child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 10),
          DropdownButtonFormField<String>(value: layer, decoration: const InputDecoration(labelText: 'Layer'),
          ...
          const SizedBox(height: 10),
          DropdownButtonFormField<String>(value: complexity, decoration: const InputDecoration(labelText: 'Complexity'),
            dropdownColor: AppColors.surface,
    ...
    return showDialog<Map<String, dynamic>>(context: context, builder: (ctx) =>
      StatefulBuilder(builder: (ctx, ss) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          DropdownButtonFormField<String>(value: from, decoration: const InputDecoration(labelText: 'From Module'),
            dropdownColor: AppColors.surface,
          ...
          const SizedBox(height: 10),
          DropdownButtonFormField<String>(value: to, decoration: const InputDecoration(labelText: 'To Module'),
            dropdownColor: AppColors.surface,
            items: ids.map((v) => DropdownMenuItem(value: v, child: Text(v, style: GoogleFonts.inter(color: AppColors.textPrimary)))).toList(),
            onChanged: (v) => ss(() => to = v!)),
          const SizedBox(height: 10),
          ...
          const SizedBox(height: 10),
          DropdownButtonFormField<String>(value: strength, decoration: const InputDecoration(labelText: 'Strength'),
            dropdownColor: AppColors.surface,
            items: ['low','medium','high'].map((v) => DropdownMenuItem(value: v, child: Text(v, style: GoogleFonts.inter(color: AppColors.textPrimary)))).toList(),
